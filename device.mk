...
$(call inherit-product, device/Letv/X3_HK/vendor/copyfiles.mk)
$(call inherit-product, vendor/Letv/X3_HK/X3_HK-vendor-blobs.mk)
...
#	LOCAL_KERNEL := device/Letv/X3_HK/kernel
#else
...
#PRODUCT_COPY_FILES += \
#    $(LOCAL_KERNEL):kernel
TARGET_KERNEL_SOURCE := kernel/Letv/X3_HK
